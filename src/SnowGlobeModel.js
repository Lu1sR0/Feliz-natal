    ...
    <>
      ...
      <Billboard>
        <Text
          ...
          lineHeight={0.85}
        >
          Desejamos a todos vocês um final de ano tranquilo. {'\n\n'}Que seu Natal seja abençoado com muito amor, paz e felicidade.
        </Text>
        <Text
          maxWidth={2.5}
          textAlign='center'
          ...
          fontSize='0.1'
        >
           Obrigado por todo o seu apoio e confiança em 2024. Grandes coisas estão por vir em 2025. HOHOHOHO
        </Text>
        <Text
          maxWidth={1.5}
          textAlign='center'
